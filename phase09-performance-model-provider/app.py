...
st.title("Enterprise AI Test Case Generator - Phase 9")
st.write(
    "Performance-focused version with Model Provider Layer, Fast Mode, RAG, JSON repair, Excel export, and Word export."
)
...
if st.button("Generate Enterprise Test Cases"):
    ...
    if not requirement.strip():
        ...
        if fast_mode:
            ...
            st.info(
                "Fast Mode enabled: skipping detailed Requirement Analyzer Agent."
            )
